...
function t6() {
    ...
    let iterNum = document.querySelector('.i-6').value;
    console.log(iterNum);
...
function t7() {
    ...
    let iterNum = document.querySelector('.i-7').value;
    for (let i = iterNum; i >= 0; i--) {
        out.textContent += i + '_';
    }
}
...
function t11() {
    ...
    for (let i = 0; i < divs.length; i++) {
        out.textContent += divs[i].textContent + '_';
    }
