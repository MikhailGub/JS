...
function f4() {
    ...
    let mC = document.querySelector('.i-4');
    if (mC.checked) {
...
function f5() {
    ...
    let mC = document.querySelector('.i-5');
    if (mC.checked) {
        out.textContent = mC.value
    }
    else {
        out.textContent = false;
    }
...
function f6() {
    ...
    let mC = document.querySelector('.i-6');
    out.textContent = mC.value;
}
...
function f7() {
    let outA = document.querySelector('.out-71');
    let outB = document.querySelector('.out-72');
    let i = document.querySelector('.i-7');
    outA.textContent = i.value;
    if (i.value.length >= 6 ) {
        outB.textContent = 1;
    }
    else {
...
function f9() {
    ...
    let r2 = document.querySelector('.r-9');
    if (r2.checked) {
        out.textContent = r2.value;
    }
    else {
        out.textContent = false;
    }
...
function f10() {
    ...
    let colVal = document.querySelector('.i-10');
    out.style.background = colVal.value;
}
...
function f13() {
    ...
    let data = document.querySelector('.i-13');
...
function f14() {
    ...
    let data = document.querySelector('.t-14');
    out.textContent = data.value;
}
...
function f15() {
    ...
    let outText = document.querySelector('.t-15');
    let data = document.querySelector('.i-15');
    outText.textContent = data.value;
    out.textContent = data.value;
}
...
function f16() {
    ...
    let data = document.querySelector('.s-16').value;
...
function f17() {
    ...
    let data = document.querySelector('.s-17').value;
    out.textContent = data;
}
...
function f18() {
    ...
    let data = document.querySelector('.s-18').value;
    out.value = data;
}
...
function f19() {
    let out = document.querySelector('.i-19');
    let data = document.querySelector('.out-19');
    out.value = data.textContent;
}
...
function f20() {
    let a = document.querySelector('.s-201');
