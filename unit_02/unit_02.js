...
// По нажатию на кнопку .b-8 выполняется функция, которая выводит в div.out-8 то, что пользователь ввел в input.i-8.
    let t8 = document.querySelector('.b-8');
    t8.onclick = function () {
...
function t9 () {
    let inPad = document.querySelector('.i-9');
    let out  = document.querySelector('.out-9');
    out.textContent = inPad.value;
    inPad.value = '';
}
...
function t10() {
    let entry = document.querySelector('.i-10').value;
    document.querySelector('.out-10').textContent = entry * 10;
}
...
function t11() {
    let entry = document.querySelector('.i-11').value;
    document.querySelector('.out-11').textContent = entry + 55 
}
...
function t12() {
    let entry = document.querySelector('.i-12-1').value;
    let entryF = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').textContent = 'Hello ' + entry + ' ' + entryF;
}
...
function t14() {
    let entry = document.querySelector('.i-14');
    entry.value = "GO"
}
...
function t15() {
    let p = document.querySelector('.i-15');
